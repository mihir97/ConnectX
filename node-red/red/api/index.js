...
var mqtt_server = "ec2-52-40-46-54.us-west-2.compute.amazonaws.com";
var topic = "json_flow";
...
function init(_server,_runtime) {
	...
	adminApp.post("/mqttpub", function (req, res) {
            //checkpoint
	    //mqtt
	    //publish the data to MQTT
	    var data = req.body.flows;
            ...
            console.log("Successfully published to MQTT");
